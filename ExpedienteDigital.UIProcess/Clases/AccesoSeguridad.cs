...
//using ExpedienteDigital.UIProcess.WCF_Seguridad;
using ExpedienteDigital.UIProcess.WCF_ServicioExpedienteDigital;


namespace ExpedienteDigital.UIProcess.Clases
{
    public class AccesoSeguridad
    {
        ...
        //WCF_ExpedienteDigital.ExpedienteDigitalAPIClient WCF_ExpedienteDigital = new UIProcess.WCF_ExpedienteDigital.ExpedienteDigitalAPIClient();
        //WCF_Seguridad.TEC_Credenciales SegCredenciales = new TEC_Credenciales();
        WCF_ServicioExpedienteDigital.ServiciosExpedienteDigitalClient WCF_ServiciosExpedienteDigital = new ServiciosExpedienteDigitalClient();
