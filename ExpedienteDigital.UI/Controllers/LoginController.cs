...
using ExpedienteDigital.UIProcess.Clases;
using System;
...
namespace ExpedienteDigital.UI.Controllers
{
    public class LoginController : Controller
    {
        ...
        //Consultar roles
        public JsonResult ConsultarEsAdminExpedienteDigital()
        {
            try
            {
                /*
                ...
                else
                {
                    ...
                    int codRolAdminExpedienteDigital = int.Parse(ConfigurationManager.AppSettings["CodRolAdim"].ToString());
                    foreach (var itm in respuesta.ObjetoRespuesta)
                    {                     
                        if (itm.IdRol == codRolAdminExpedienteDigital)
                        {
